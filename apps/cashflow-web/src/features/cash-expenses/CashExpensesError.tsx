type CashExpensesErrorProps = {
  onRetry: () => void
}

export function CashExpensesError({ onRetry }: CashExpensesErrorProps) {
  return (
    <div className="rounded-md border border-[#f0d1c8] bg-[#fff7f4] p-5 text-[#8a3d2f] shadow-sm">
      <h3 className="text-base font-semibold">Não foi possível carregar as saídas</h3>
